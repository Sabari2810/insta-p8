...
const automations: Row[] = [
  { id: "auto-1", user_id: DEMO_USER_ID, name: "Free guide DM", trigger_source: "comment", trigger_type: "keyword", trigger_value: "guide", response_type: "pro", response_content: { message: "Here's your free guide! 🎉 {link}" }, is_active: true, specific_media_id: null, trigger_count: 128, unlock_count: 96, created_at: isoDaysAgo(20) },
  { id: "auto-2", user_id: DEMO_USER_ID, name: "Pricing FAQ", trigger_source: "dm", trigger_type: "keyword", trigger_value: "price", response_type: "pro", response_content: { message: "Our rate card is linked below 👇" }, is_active: true, specific_media_id: null, trigger_count: 54, unlock_count: 41, created_at: isoDaysAgo(15) },
  { id: "auto-3", user_id: DEMO_USER_ID, name: "Story reaction", trigger_source: "story", trigger_type: "keyword", trigger_value: "🔥", response_type: "pro", response_content: { message: "Glad you liked it! Check the link in bio." }, is_active: true, specific_media_id: null, trigger_count: 33, unlock_count: 20, created_at: isoDaysAgo(10) },
  { id: "auto-4", user_id: DEMO_USER_ID, name: "Collab inquiries", trigger_source: "comment", trigger_type: "keyword", trigger_value: "collab", response_type: "pro", response_content: { message: "Thanks for reaching out — sending details now!" }, is_active: false, specific_media_id: null, trigger_count: 9, unlock_count: 4, created_at: isoDaysAgo(3) },
  { id: "auto-5", user_id: DEMO_USER_ID, name: "Discount code", trigger_source: "dm", trigger_type: "keyword", trigger_value: "discount", response_type: "pro", response_content: { message: "Use code WELCOME10 at checkout!" }, is_active: true, specific_media_id: null, trigger_count: 71, unlock_count: 58, created_at: isoDaysAgo(1) },
]
