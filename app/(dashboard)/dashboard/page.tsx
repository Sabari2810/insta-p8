...
export default function DashboardPage() {
    ...
    return (
        <div className="p-8 space-y-8 animate-in fade-in duration-700">
            {/* Welcome Section */}
            <div className="rounded-2xl border border-black/10 bg-white p-6 flex items-center justify-between gap-6 flex-wrap">
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <Card className="p-6 bg-white border-black/10">
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <Link href="/activity" className="text-xs font-medium text-brand hover:underline">View all</Link>
                    </div>
                    <div>
